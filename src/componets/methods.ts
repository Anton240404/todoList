function _indexOf<T>(arr: T[], callback: (value: T, index: number) => boolean): number {
...
function _pop<T>(array: T[], value: number) {
...
console.log(_pop<number>(array, 5))
console.log('====================')
...
function _some<T>(array: T[], callback: (value: T, index: number) => boolean): boolean {
    for (let i = 0; i < array.length; i++) {
